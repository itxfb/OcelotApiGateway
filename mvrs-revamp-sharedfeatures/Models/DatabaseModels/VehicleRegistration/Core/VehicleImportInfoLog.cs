...
{
    public class VehicleImportInfoLog : BaseModel
    {
        [Key]
        public long VehicleImportInfoLogId { get; set; }

        [ForeignKey("VehicleImportInfo")]
        public long VehicleImportInfoId { get; set; }
        public virtual VehicleImportInfo VehicleImportInfo { get; set; }
