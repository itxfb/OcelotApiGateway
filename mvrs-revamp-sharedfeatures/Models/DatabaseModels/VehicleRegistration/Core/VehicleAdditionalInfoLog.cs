...
{
    public class VehicleAdditionalInfoLog : BaseModel
    {
        [Key]
        public long VehicleAdditionalInfoLogId { get; set; }

        [ForeignKey("VehicleAdditionalInfo")]
        public long VehicleAdditionalInfoId { get; set; }
        public virtual VehicleAdditionalInfo VehicleAdditionalInfo { get; set; }
